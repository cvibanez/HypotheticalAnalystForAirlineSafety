...
fig <- fig %>% layout(title = 'U.S. Vehicle Fatalities from 1899 - 2018',
                      yaxis = list(title = 'Fatalities', showticklabels = TRUE, tickprefix="<b>",ticksuffix ="</b><br>"),xaxis=list(title = 'Year'))
...
fig <- fig %>% layout(title = 'U.S. Airline Fatalities from 1983 - 2014',
                      yaxis = list(title = 'Fatalities', showticklabels = TRUE, tickprefix="<b>",ticksuffix ="</b><br>"),xaxis=list(title = 'Year'))
